            ...
            <li key={step.name} className={classNames(stepIdx !== steps.length - 1 ? '' : '', 'relative')}>
              {step.status === 'complete' ? (
                <>
                  ...
                  <a className="group" onClick={() => stepClickHandler(stepIdx)}>
                ...
                <>
                  ...
                  <a className="flex items-start" aria-current="step" onClick={() => stepClickHandler(stepIdx)}>
                    ...
                    <span className="ml-3 text-sm font-medium text-black">{step.name}</span>
                  </a>
                </>                
              ) : (
                <>
