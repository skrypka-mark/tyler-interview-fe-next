...
export default function StepsForm() {
  ...
  const [steps, { currentIndex, push, goBack, goNext }] = useSteps([
    { name: 'Property detail', hash: '#property-detail', status: 'upcoming', Component: PropertyDetailForm },
    { name: 'Rent roll', hash: '#rent-roll', status: 'upcoming', Component: RentRollForm },
    { name: 'Financing', hash: '#financing', status: 'upcoming', Component: FinancingForm },
    { name: 'Income & Expenses', hash: '#income-expenses', status: 'upcoming', Component: IncomeExpensesForm },
  ]);
