...
export default function FinancingForm({ goNext, goBack }) {
  ...
  const isFromValid = useMemo(
    () => !Object.values(financingFormData).some((filed) => !filed),
    [financingFormData]
  );
    ...
    >
      ...
      <div className="relative">
        <TextField
          ...
          onChange={inputChangeHandler}
        />
        <span className="absolute top-[50%] left-[11em] text-md font-medium">
          %
        </span>
      </div>
      ...
      <div className="flex gap-x-4">
        ...
        <div className="relative w-full">
          <TextField
            ...
            onChange={inputChangeHandler}
          />
          <span className="absolute top-[50%] right-[1em] text-sm font-medium">
            months
          </span>
        </div>
      </div>
